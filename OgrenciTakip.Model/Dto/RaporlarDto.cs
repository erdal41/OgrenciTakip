...
{
    public class GenelAmacliRaporList
    {
    ...
    public class HizmetAlimRaporuList
    {
        public long OgrenciId { get; set; }
        public long TahakkukId { get; set; }
        public long SubeId { get; set; }
    ...
    public class NetUcretRaporuList
    {
        public long OgrenciId { get; set; }
        public long TahakkukId { get; set; }
        public long SubeId { get; set; }
    ...
    public class UcretVeOdemeRaporuList
    {
        public long OgrenciId { get; set; }
        public long TahakkukId { get; set; }
        public long SubeId { get; set; }
    ...
    public class IndirimDagilimRaporuList
    {
        public long OgrenciId { get; set; }
        public long TahakkukId { get; set; }
        public long SubeId { get; set; }
    ...
    public class MesleklereGoreKayitRaporuList
    {
        public string SubeAdi { get; set; }
    ...
    public class AylikKayitRaporuList
    {
    ...
    public class GelirDagilimRaporuList
    {
        public int Yil { get; set; }
    ...
    public class UcretOrtalamalariRaporuList
    {
        public string SubeAdi { get; set; }
    ...
    public class OdemeBelgeleriRaporuList
    {
        public long TahakkukId { get; set; }
        public long SubeId { get; set; }
        public long DonemId { get; set; }
    ...
    public class TahsilatRaporuList
    {
        public long SubeId { get; set; }
        public long DonemId { get; set; }
        public string OgrenciSubeAdi { get; set; }
    ...
    public class OdemesiGecikenAlacaklarRaporuList
    {
        public long SubeId { get; set; }
        public long DonemId { get; set; }
        public string OgrenciSubeAdi { get; set; }
