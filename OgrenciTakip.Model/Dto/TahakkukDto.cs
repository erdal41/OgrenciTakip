...
{
    [NotMapped]
    public class TahakkukSingle : Tahakkuk
    {
    ...
    public class TahakkukList : BaseEntity
    {
        ...
        public string SonrakiDonemKayitDurumuAciklamasi { get; set; }
        public string OzelKod1Adi { get; set; }
        public string OzelKod2Adi { get; set; }
        public string OzelKod3Adi { get; set; }
        public string OzelKod4Adi { get; set; }
    ...
    public class OgrenciTahakkukList
    {
