...
namespace OgrenciTakip.Model.Entities
{
    public class DonemParametre : BaseEntity
    {
        ...
        public bool HizmetTahakkukKurusKullan { get; set; } = true;
        public bool IndirimTahakkukKurusKullan { get; set; } = true;
        public bool OdemePlaniKurusKullan { get; set; } = true;
        public bool FaturaTahakkukKurusKullan { get; set; } = true;
