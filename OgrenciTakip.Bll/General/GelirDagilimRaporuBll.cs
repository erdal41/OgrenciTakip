...
namespace OgrenciTakip.Bll.General
{
    ...
    {
        public IEnumerable<GelirDagilimRaporuList> List(Expression<Func<OdemeBilgileri, bool>> filter, GruplamaTuru hesaplamaSekli)
        {
            return List(filter, x => new
            {
                ...
                }).Select(x => new GelirDagilimRaporuList
                {
