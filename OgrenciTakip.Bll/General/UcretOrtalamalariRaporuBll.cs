...
namespace OgrenciTakip.Bll.General
{
    ...
    {
        public IEnumerable<UcretOrtalamalariRaporuList> List(Expression<Func<Tahakkuk, bool>> filter)
        {
            ...
            }).AsEnumerable().GroupBy(x => new { x.Tahakkuk.SubeId, x.Tahakkuk.SinifId }).Select(x => new UcretOrtalamalariRaporuList
            {
