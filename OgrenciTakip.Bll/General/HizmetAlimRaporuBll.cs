...
namespace OgrenciTakip.Bll.General
{
    ...
    {
        public IEnumerable<HizmetAlimRaporuList> List(Expression<Func<Tahakkuk, bool>> filter, IEnumerable<long> hizmetTurleri, HizmetAlimDurumu hizmetAlimDurumu)
        {
            ...
            }).Where(x => hizmetAlimDurumu == HizmetAlimDurumu.HizmetiAlanlar ? x.HizmetAlimDurumu : !x.HizmetAlimDurumu).Select(x => new HizmetAlimRaporuList
            {
