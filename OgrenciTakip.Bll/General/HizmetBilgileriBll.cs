...
namespace OgrenciTakip.Bll.General
{
    public class HizmetBilgileriBll : BaseHareketBll<HizmetBilgileri, OgrenciTakipContext>, IBaseHareketSelectBll<HizmetBilgileri>
    {
        ...
        {
            return List(filter, x => new HizmetBilgileriList
            {
                Id = x.Id,
        ...
        public IEnumerable<FaturaAlinanHizmetlerList> FaturaPlaniList(Expression<Func<HizmetBilgileri, bool>> filter)
        {
            ...
            }).Select(x => new FaturaAlinanHizmetlerList
            {
