        ...
        public IEnumerable<BaseHareketEntity> List(Expression<Func<OdemeBilgileri, bool>> filter)
        {
            return List(filter, x => new
            {
                ...
                Toplamlar = x.MakbuzHareketleri.GroupBy(y => y.OdemeBilgileriId).DefaultIfEmpty().Select(y => new
                {
                    ...
                    Tahsilde = y.Where(z => z.BelgeDurumu == BelgeDurumu.AvukataGonderme || z.BelgeDurumu == BelgeDurumu.BankayaTahsileGonderme || z.BelgeDurumu == BelgeDurumu.CiroEtme || z.BelgeDurumu == BelgeDurumu.BlokeAlma).Select(z => z.IslemTutari).DefaultIfEmpty(0).Sum() - y.Where(z => z.BelgeDurumu == BelgeDurumu.AvukatYoluylaTahsilEtme || z.BelgeDurumu == BelgeDurumu.BankaYoluylaTahsilEtme || z.BelgeDurumu == BelgeDurumu.BlokeCozumu || z.BelgeDurumu == BelgeDurumu.KismiAvukatYoluylaTahsilEtme
                    || z.BelgeDurumu == BelgeDurumu.OdenmisOlarakIsaretleme || z.BelgeDurumu == BelgeDurumu.PortfoyeGeriIade || z.BelgeDurumu == BelgeDurumu.PortfoyeKarsiliksizIade).Select(z => z.IslemTutari).DefaultIfEmpty(0).Sum(),
            ...
            }).Select(x => new OdemeBilgileriList
            {
                ...
                BankaSubeAdi = x.OdemeBelgesi.BankaSube.BankaSubeAdi,
