...
namespace OgrenciTakip.Bll.General
{
    public class MakbuzHareketleriBll : BaseHareketBll<MakbuzHareketleri, OgrenciTakipContext>, IBaseHareketSelectBll<MakbuzHareketleri>
    {
        ...
        {
            return List(filter, x => new MakbuzHareketleriList
            {
                Id = x.Id,
                MakbuzId = x.MakbuzId,
                ...
                SonIslemYeri = x.OdemeBilgileri.MakbuzHareketleri.Where(y => y.OdemeBilgileriId == x.OdemeBilgileri.Id).Max(y =>      y.Makbuz.AvukatHesapId != null ? y.Makbuz.AvukatHesap.AdiSoyadi :
