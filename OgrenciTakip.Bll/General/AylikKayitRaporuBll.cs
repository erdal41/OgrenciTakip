...
namespace OgrenciTakip.Bll.General
{
    ...
    {
        public IEnumerable<AylikKayitRaporuList> List(Expression<Func<Tahakkuk, bool>> filter)
        {
            ...
            }).AsEnumerable().GroupBy(x => new { x.Tahakkuk.KayitTarihi.Year, x.Tahakkuk.KayitTarihi.Month }).Select(x => new AylikKayitRaporuList
            {
                Yil = x.Key.Year,
