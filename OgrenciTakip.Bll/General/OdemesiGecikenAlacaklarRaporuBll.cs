...
namespace OgrenciTakip.Bll.General
{
    ...
    {
        public IEnumerable<OdemesiGecikenAlacaklarRaporuList> List(Expression<Func<OdemeBilgileri, bool>> filter, IEnumerable<BelgeDurumu> belgeDurumlari)
        {
            ...
            }).Select(x => new OdemesiGecikenAlacaklarRaporuList
            {
