...
namespace OgrenciTakip.Bll.General
{
    ...
    {
        public IEnumerable<IndirimDagilimRaporuList> List(Expression<Func<Tahakkuk, bool>> filter, IEnumerable<long> indirimTurleri)
        {
            ...
            }).Where(x => x.IndirimBilgileri.BrutIndirim > 0).Select(x => new IndirimDagilimRaporuList
            {
