...
namespace OgrenciTakip.UI.Win.Forms.OgrenciForms
{
    public partial class OgrenciEditForm : BaseEditForm
    {
        public OgrenciEditForm()
        {
            ...
            Bll = new OgrenciBll(myDataLayoutControl); //Hata durumunda kontrollere focuslanma için
            ...
            BaseKartTuru = KartTuru.Ogrenci;    //Kartturu form isimleri için
            EventsLoad();
        }
        ...
        public override void Yukle()
        {
            ...
            OldEntity = BaseIslemTuru == IslemTuru.EntityInsert ? new OgrenciSingle() : ((OgrenciBll)Bll).Single(FilterFunctions.Filter<Ogrenci>(Id));
