...
namespace OgrenciTakip.Data.Contexts
{
    public class OgrenciTakipContext : BaseDbContext<OgrenciTakipContext, Configuration>
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            //ile baðlý ilçe olabilir. Il silininde ona baðlý ilçeleri de siler.
            ...
            //modelBuilder.Entity<Tahakkuk>().HasRequired(x => x.HizmetBilgileri).WithMany().WillCascadeOnDelete(true);
            //modelBuilder.Entity<Tahakkuk>().HasRequired(x => x.OdemeBilgileri).WithMany().WillCascadeOnDelete(true);
        }
